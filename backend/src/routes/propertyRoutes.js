...
const {createProperty, getProperties, getProperty, updateProperty, deleteProperty,getPropertiesByLandlordId} = require("../controllers/propertyController");
...
router.get("/landlord/allproperty", authMiddleware(), getPropertiesByLandlordId); // Fetch all properties of a landlord
