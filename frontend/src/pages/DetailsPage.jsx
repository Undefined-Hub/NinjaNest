        ...
        <>
            {zoomedImage && (
                <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50" onClick={() => setZoomedImage(null)}>
                    <img src={zoomedImage} alt="Zoomed" className="max-w-full max-h-full p-3" />
                </div>
            )}
                    ...
                    <div className='flex flex-col w-full lg:w-2/3 space-y-4'>
                        <div className='flex p-3 bg-sub-bg rounded-xl'>
                            <div className='w-full rounded-xl flex flex-col space-y-3'>
                                <div className='h-56 sm:min-h-[320px] md:h-[400px] lg:h-[480px]' onClick={() => setZoomedImage(house)}>
                                    <img src='https://placehold.co/600x400' alt='Property' className='w-full h-full object-cover rounded-xl hover:cursor-pointer' />
                                </div>
                                <div>
                                    <div className='grid grid-cols-3 sm:grid-cols-3 md:grid-cols-5 gap-2 sm:gap-3'>
                                        {[...Array(5)].map((_, index) => (
                                            <div key={index} className='w-full h-14 sm:h-20 rounded-xl overflow-hidden' onClick={() => setZoomedImage(house1)}>
